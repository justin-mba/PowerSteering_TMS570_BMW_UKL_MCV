 ...
 *  Generated at:  Thu Jan 15 11:13:09 2015
 *
...
# define Rte_InitValue_AsstFirewallActive_Uls_f32 ((Float)0)
# define Rte_InitValue_BaseAssistCmd_MtrNm_f32 ((Float)0)
# define Rte_InitValue_CombinedAssist_MtrNm_f32 ((Float)0)
# define Rte_InitValue_Defeat_AsstTbl_Service_Cnt_lgc ((Boolean)FALSE)
...
# define Rte_InitValue_MEC_Counter_Cnt_enum ((ManufModeType)0u)
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Rte_ModeType_StaMd_Mode, RTE_CODE) Rte_Mode_Ap_AssistFirewall_SystemState_Mode(void);
 ...
 * Rte_Mode_<p>_<m>
 *********************************************************************************************************************/
# define Rte_Mode_SystemState_Mode Rte_Mode_Ap_AssistFirewall_SystemState_Mode
...
#   if RTE_MAGIC_NUMBER != 1421322128
#    error "The magic number of the generated file <C:/SynergyWorkspace/WorkingProjects/AssistFirewall-gzkys7/AssistFirewall/utp/contract/Ap_AssistFirewall/Rte_Ap_AssistFirewall.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1421322128

...
/*******  VAR sections  **********************************************************************************************/
    ...
    #define START_SEC_VAR_NOINIT_UNSPECIFIED_GLOBALSHARED /* Temporarily allocated to Global Shared to allow access across applications until Nexteer Adc driver is developed */
#endif

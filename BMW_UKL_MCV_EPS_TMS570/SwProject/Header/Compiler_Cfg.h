...
#define SC_SWT_ENABLE                           STD_ON 	   //NEXTEER SWT    /* Is the SWT security mechanism relevant for this ECU? */
#define SC_CODING_ENABLE                        STD_ON 
#define SC_CSM_ENABLE                           STD_OFF
#define SC_PIA_ENABLE                           STD_OFF
#define DM_TEST                                 STD_ON

/* NEXTEER SWT *///NEXTEER SWT - added was not defined */

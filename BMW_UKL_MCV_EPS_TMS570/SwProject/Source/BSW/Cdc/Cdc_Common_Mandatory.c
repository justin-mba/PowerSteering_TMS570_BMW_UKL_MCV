   ...
   Dcm_StatusType retVal;
      ...
      else
      {
            ...
            (
               ...
               (uint16)           0,
               /* auth level                                                  */
               (uint32)           CDD_CdcAuthLevel_Cnt_G_u8,		/* Nexteer Patch -- Added 09/30/12, KJS: Removed CDC_AUTH_LEVEL and replaced it with CDD_CdcAuthLevel_Cnt_G_u8 defined in CDD_Data */
               /* response                                                    */

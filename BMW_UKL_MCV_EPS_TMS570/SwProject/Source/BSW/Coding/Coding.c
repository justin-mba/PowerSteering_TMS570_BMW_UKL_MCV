     ...
     Coding_RequestBlock( Coding_BlockIdType blockId )
{
   ...
   Coding_Call_CbkBlock_Receive( blockId,
                                 (P2VAR( Coding_BlockDataType, AUTOMATIC, CODING_VAR_NVDATA ))pData, /* Nexteer correction to remove extraneous referencing operator since pData is a pointer to the data */

...
FUNC(void, DEM_CODE) Dem_ResetDebounceFrequencyBased(Dem_EventIdType EventId)
{
    ...
    * ENTER critical section
    */
   SchM_Exit_Dem(SCHM_DEM_INSTANCE_0, SCHM_DEM_EXCLUSIVE_AREA_0); /* Nexteer Patch: Changed to Exit call from SchM_Exit_Dem(SCHM_DEM_INSTANCE_0, SCHM_DEM_EXCLUSIVE_AREA_0);  */
}

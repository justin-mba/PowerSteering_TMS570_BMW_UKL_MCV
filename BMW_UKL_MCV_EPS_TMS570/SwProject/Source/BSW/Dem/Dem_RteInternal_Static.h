...
/* Start Nexteer Patch block. Added to workaround usrostype.h inclusion of Rte_Type.h */
#include "Rte_Type.h"
#include "Dem_Api_Cfg.h"
#if (!defined DEM_INCLUDE_RTE)
	#define DEM_INCLUDE_RTE STD_OFF
#endif
/* End Nexteer Patch Block */
...
#if (DEM_INCLUDE_RTE == STD_OFF) /* Nexteer Patch. Added to workaround usrostype.h inclusion of Rte_Type.h */
/*------------------[Dem_EventStatusType]-----------------------------------*/
...
#endif /* Nexteer Patch. (DEM_INCLUDE_RTE == STD_OFF) Nexteer add to workaround usrostype.h inclusion of Rte_Type.h */

...
#pragma DATA_ALIGN ( NvMP_Rte_MtrPos_MtrPosSnsr_EOLData, 4U); /* NEXTEER PATCH: Added to force 32-bit alignment: A_5202 */
VAR(uint8, AUTOMATIC) NvMP_Rte_MtrPos_MtrPosSnsr_EOLData[sizeof(Rte_MtrPos_MtrPosSnsr_EOLData)];

#pragma DATA_ALIGN ( NvMP_Rte_MtrCurr_ShCurrCal, 4U); /* NEXTEER PATCH: Added to force 32-bit alignment: A_5202 */
VAR(uint8, AUTOMATIC) NvMP_Rte_MtrCurr_ShCurrCal[sizeof(Rte_MtrCurr_ShCurrCal)];

#pragma DATA_ALIGN ( NvMP_Rte_HwTrq_HwTrqScaleData, 4U); /* NEXTEER PATCH: Added to force 32-bit alignment: A_5202 */
VAR(uint8, AUTOMATIC) NvMP_Rte_HwTrq_HwTrqScaleData[sizeof(Rte_HwTrq_HwTrqScaleData)];

#pragma DATA_ALIGN ( NvMP_Rte_HwTrq_HwTrqTrimData, 4U); /* NEXTEER PATCH: Added to force 32-bit alignment: A_5202 */
VAR(uint8, AUTOMATIC) NvMP_Rte_HwTrq_HwTrqTrimData[sizeof(Rte_HwTrq_HwTrqTrimData)];

#pragma DATA_ALIGN ( NvMP_Rte_HwTrq_EOLTrqStepData, 4U); /* NEXTEER PATCH: Added to force 32-bit alignment: A_5202 */
VAR(uint8, AUTOMATIC) NvMP_Rte_HwTrq_EOLTrqStepData[sizeof(Rte_HwTrq_EOLTrqStepData)];

#pragma DATA_ALIGN ( NvMP_Rte_ParamComp_EOLNomMtrParam, 4U); /* NEXTEER PATCH: Added to force 32-bit alignment: A_5202 */
VAR(uint8, AUTOMATIC) NvMP_Rte_ParamComp_EOLNomMtrParam[sizeof(Rte_ParamComp_EOLNomMtrParam)];

#pragma DATA_ALIGN ( NvMP_Rte_AbsHwPos_Trim, 4U); /* NEXTEER PATCH: Added to force 32-bit alignment: A_5202 */
VAR(uint8, AUTOMATIC) NvMP_Rte_AbsHwPos_Trim[sizeof(Rte_AbsHwPos_Trim)];

#pragma DATA_ALIGN ( NvMP_Rte_TrqCmdScl_TorqueCmdSF_Uls_f32, 4U); /* NEXTEER PATCH: Added to force 32-bit alignment: A_5202 */
VAR(uint8, AUTOMATIC) NvMP_Rte_TrqCmdScl_TorqueCmdSF_Uls_f32[sizeof(Rte_TrqCmdScl_TorqueCmdSF_Uls_f32)];

#pragma DATA_ALIGN ( NvMP_Rte_Polarity_k_SystemPolarity_Cnt_b16, 4U); /* NEXTEER PATCH: Added to force 32-bit alignment: A_5202 */
VAR(uint8, AUTOMATIC) NvMP_Rte_Polarity_k_SystemPolarity_Cnt_b16[sizeof(Rte_Polarity_k_SystemPolarity_Cnt_b16)];

#pragma DATA_ALIGN ( NvMP_Rte_TurnsCounter_EOLTurnsCntrCals, 4U); /* NEXTEER PATCH: Added to force 32-bit alignment: A_5202 */
VAR(uint8, AUTOMATIC) NvMP_Rte_TurnsCounter_EOLTurnsCntrCals[sizeof(Rte_TurnsCounter_EOLTurnsCntrCals)];

#pragma DATA_ALIGN ( NvMP_CloseCheck_Cnt_u32, 4U); /* NEXTEER PATCH: Added to force 32-bit alignment: A_5202 */
VAR(uint8, AUTOMATIC) NvMP_CloseCheck_Cnt_u32[sizeof(CloseCheck_Cnt_u32)];

#pragma DATA_ALIGN ( NvMP_Rte_LrnEOT_LearnedEOT, 4U); /* NEXTEER PATCH: Added to force 32-bit alignment: A_5202 */

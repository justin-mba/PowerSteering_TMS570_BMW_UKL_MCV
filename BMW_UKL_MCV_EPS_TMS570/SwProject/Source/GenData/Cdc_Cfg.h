...
#endif
/* -------------------------------------------------------------------------- */
#if (SC_LED_DEMO_ON == STD_ON) /*Nexteer patch*/
...
/* NEXTEER SWT - added for SWT security access */
 ...
 */
#define CDC_AUTH_LEVEL 0x04u /*NEXTEER SWT PATCH 9/29/12 needed for level 4 security access, value was 0x03u */
 ...
 */
   ...
   /* NEXTEER SWT */	//changed Cdc_Dispatcher to call Swt_DcmRoutineControlSwtOperation directly    #define CDC_SWT_DCMROUTINECONTROLSWTOPERATION(0x30, pMsgC)           Swt_DcmRoutineControlSwtOperation( Sgid, pMsgC )///* NEXTEER SWT */ - CDCSWT compatibility issues Swt_DcmRoutineControlSwtOperation(pMsgC)

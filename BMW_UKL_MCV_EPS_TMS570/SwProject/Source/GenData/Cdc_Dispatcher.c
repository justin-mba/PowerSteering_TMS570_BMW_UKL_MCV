...
/* Nexteer Patch - Added 09/30/12, KJS: Added this include for CDC_AUTH_LEVEL correction */
#include "CDD_Data.h"
            ...
            switch (pendingDiagContext.DataOrRoutineId)
            {
               ...
               case DIAG_RID_0F06_CLEAR_DTC_SECONDARY_MEMORY:
                ...
                case DIAG_RID_0F1F_SWT_OPERATION:
                  Swt_DcmRoutineControlSwtOperation(0x30, pMsgContext);/* NEXTEER SWT */ //  CDC_SWT_DCMROUTINECONTROLSWTOPERATION(Sgid, pMsgContext);
                  break;
#endif
...
#if (CdcUseUserExtension == STD_ON)
	/* NEXTEER SWT */// - CDCSWT patch, added SWT get seed request

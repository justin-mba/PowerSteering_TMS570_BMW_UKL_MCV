...
/*** Private Part (used by Coding.c only) *************************************/
    ...
    */
   /* Deviation MISRA-2 */
/* Nexteer patch - The correct vehicle speed signal, Com_V_VEH_COG__V_VEH, does not appear in the drop down list when selecting the 'speed signal' using Configurator.

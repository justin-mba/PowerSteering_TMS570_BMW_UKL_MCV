/**************************************************************************************************
  ...
  -------------------------------------------------------------------------------------------------
   ...
   vl           Martin Viereckel          Vector Informatik GmbH
   grm          Marcus Grande             Vector Informatik GmbH
   lz           Rainer Lutz               Vector Informatik GmbH
   bra          Andre Baur                Vector Informatik GmbH
  -------------------------------------------------------------------------------------------------

...
#define VSM_EVENTID_VEHICLESTATE VSM_EVENT_VEHICLESTATE  /*NEXTEER - The DTC for event ID VSM_EVENT_VEHICLESTATE was removed - updated configurator with VSM_EVENT_OPMODE since configurator required an EVENT ID in order to generate */

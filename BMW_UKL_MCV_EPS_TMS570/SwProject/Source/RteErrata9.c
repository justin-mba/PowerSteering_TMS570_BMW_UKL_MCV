 ...
 **********************************************************************************************************************
 ...
 ==========
  ...
  D_SVCDFTDRIVINGDYN_CNT_B32
    Torque Overlay defeat is bit 13 per PID $FD02 in teh EA 3.0_Nexteer Common Mfg Serv Spec
     
     Bit 13 =  2^13=8192

  D_SVCDFTHYSTADD_CNT_B32
    Hysteresis Add defeat is bit 15 per PID $FD02 in the EA 3.0_Nexteer Common Mfg Serv Spec
     
     Bit 15 =  2^15=32768

  D_SVCDFTPARKAST_CNT_B32
    Parking Assist defeay is bit 12 per PID $FD02 in teh EA 3.0_Nexteer Common Mfg Serv Spec

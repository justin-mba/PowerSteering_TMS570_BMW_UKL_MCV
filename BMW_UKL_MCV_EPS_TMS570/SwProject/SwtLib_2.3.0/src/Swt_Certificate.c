...
/* Nexteer Patch Start -- Added Start section to complete the stop section call below
...
/* Nexteer Patch Start -- Added stop section to complete the start section call above 
 * Added: 19Aug12 - KJS - To correct Memmap errors with incomplete sections
 */
#define SWT_STOP_SEC_CODE
#include "MemMap.h"

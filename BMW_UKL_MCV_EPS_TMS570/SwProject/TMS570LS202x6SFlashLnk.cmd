...
MEMORY
{
    ...
    /*----------------------------------------------------------------------------------------------------------------*/
    /* Tuning Block1 / SWE2 / Nexteer Calibration Region                                                              */
    /* Range: 0x0001 0000 - 0x0001 FFFF                                                                               */
    /*----------------------------------------------------------------------------------------------------------------*/
    CAL1_FLASH        (R)  : origin=0x00010000 length=0x0000FDA8 fill=0xFFFFFFFF /* Flash space for Nexteer cals      */
...
SECTIONS
{
    ...
    /* Configure all tuning sets and common cals to Nexteer's SWE (Cal1) */

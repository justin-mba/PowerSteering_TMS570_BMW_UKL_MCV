 ...
 * 04/26/12   19      SMW       Updated CbkBlockValid_Check function to return EOK if block is not data Nexteer is managing
 ...
 *********************************************************************************************************************/
	...
	/* Map the customer specific vehicle modes to the Standard Nexteer Modes */

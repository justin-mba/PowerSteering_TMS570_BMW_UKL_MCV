 ...
 *     Workspace:  C:/Synergy_projects/SVDiag-lz4p8n/SVDiag/autosar
 *     SW-C Type:  Ap_DigPhsReasDiag
 *  Generated at:  Fri Mar 15 09:53:22 2013
 *
 ...
 *********************************************************************************************************************/
	...
	for(i = D_PHASEA_CNT_U16; i <= D_PHASEC_CNT_U16; i++)
	{
		...
		{
			if ( (SVDiag_HighResPhsReasDisable_M_u8 < 50U) || ( (TRUE == PDActivateTest_Cnt_T_lgc) && (SVDiag_HighResPhsReasDisable_M_u8 < 100U) ) )
				{
	...
	*  Assign the previous outputs*/
	...
	{
		LRPRPhaseAdvAdj_Cnt_T_u16 = (uint16)(LRPRPhaseadvanceCaptured_Cnt_T_s16 + (sint16)D_PHSADVCNTS180DEG_CNT_U16);
	}
	...
	{
		LRPRPhaseAdvAdj_Cnt_T_u16 = (uint16)(LRPRPhaseadvanceCaptured_Cnt_T_s16 + (sint16)D_PHSADVCNTSPERREV_CNT_U16);
	}
	else
	{

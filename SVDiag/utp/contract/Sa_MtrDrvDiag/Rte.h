...
#    error "The magic number of the generated file <C:/CMSynergy_Projects/CBD/SVDiag/utp/contract/Sa_MtrDrvDiag/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else

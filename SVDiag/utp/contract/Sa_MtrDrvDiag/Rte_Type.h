...
struct Rte_CDS_Sa_MtrDrvDiag
{
  ...
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_SA_MTRDRVDIAG_APPL_VAR) MtrDrvDiag_Per1_VswitchClosed_Cnt_lgc;
...
#    error "The magic number of the generated file <C:/CMSynergy_Projects/CBD/SVDiag/utp/contract/Sa_MtrDrvDiag/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
